...
namespace PolkaDotted.ObstacleRunner
{
	public class App : WaveEngine.Adapter.Application
	{
		PolkaDotted.ObstacleRunnerProject.Game game;
		...
		public App()
		{
			...
			this.WindowTitle = "PolkaDotted.ObstacleRunner";
		}

		public override void Initialize()
		{
			this.game = new PolkaDotted.ObstacleRunnerProject.Game();
